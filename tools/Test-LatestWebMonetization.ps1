...
Test-Condition (([regex]::Matches($project, 'CURRENT_PROJECT_VERSION = 14;')).Count -eq 2 -and ([regex]::Matches($project, 'MARKETING_VERSION = 3\.0\.0;')).Count -eq 2) 'Debug and Release identify App Store version 3.0.0 build 14'
