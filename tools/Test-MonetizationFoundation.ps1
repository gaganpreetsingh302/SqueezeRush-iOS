...
Test-Condition ($project.Contains('SQUEEZE_RUSH_REMOVE_ADS_PRODUCT_ID = com.kasiga.squeezerush.remove_ads;') -and $project.Contains('SQUEEZE_RUSH_REMOVE_ADS_PRODUCT_ID = "";')) 'iOS Debug uses a sandbox product identifier and Release remains empty'
Test-Condition ($project.Contains('SQUEEZE_RUSH_IAP_RELEASE_APPROVED = NO;') -and $guard.Contains('SQUEEZE_RUSH_IAP_RELEASE_APPROVED must equal YES')) 'iOS IAP Release remains explicitly blocked'
